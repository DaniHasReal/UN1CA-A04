...
if [ -d "$FW_DIR/$TARGET_FIRMWARE_PATH/system/system/saiv/image_understanding" ]; then
    ...
    ADD_TO_WORK_DIR "$SOURCE_FIRMWARE" "system" "system/saiv/image_understanding" 0 0 755 "u:object_r:system_file:s0"
fi
